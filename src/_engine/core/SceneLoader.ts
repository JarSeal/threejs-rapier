...
export const loadScene = async (loadSceneProps: LoadSceneProps) => {
  ...
  // 1. Convert variables to mutables so the debugger can intercept them
  ...
  // 2. Process Debug Start Scene Interception (First boot only)
  ...
  // 3. Resolve Scene Data using the final resolved sceneId
  nextSceneId = sceneId;
  ...
  // 4. Resolve the Stage Execution Function from your autogenerated registry module
  ...
  // 5. Resolve the Scene Loader Component context
